...
export plot_demography, plot_hist, plot_residuals, plot_naive_residuals, xy
...
function plot_demography(fits::Vector{DemoInfer.FitResult}, ax; id="", c = nothing, alp=1)
...
"""
    plot_demography(fit::DemoInfer.FitResult, ax; id="", c = nothing, alp=1)
    plot_demography(fits::Vector{DemoInfer.FitResult}, ax; id="", c = nothing, alp=1)
...
"""
function plot_demography(fit::DemoInfer.FitResult, ax; id="", c = nothing, alp=1)
    plot_demography([fit], ax; id=id, c=c, alp=alp)
end
